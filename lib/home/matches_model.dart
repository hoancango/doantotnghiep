...
class PLFixtures {
  ...
  int? results;
  Paging? paging;
  List<TotalFixtures>? fixturesList;
  ...
  PLFixtures.fromJson(Map<String, dynamic> json) {
    get = json['get'];
    ...
    if (json['response'] != null) {
      fixturesList = <TotalFixtures>[];
      json['response'].forEach((v) {
        fixturesList!.add(new TotalFixtures.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.fixturesList != null) {
      data['response'] = this.fixturesList!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class TotalFixtures {
  ...
  TotalFixtures({this.fixture, this.league, this.teams, this.goals, this.score});

  TotalFixtures.fromJson(Map<String, dynamic> json) {
    fixture =
