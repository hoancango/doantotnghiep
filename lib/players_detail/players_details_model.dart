class TotalPlayersDetails {
  String? get;
  Parameters? parameters;
  int? results;
  Paging? paging;
  List<TotalPlayer>? totalPlayer;

  TotalPlayersDetails(
      {this.get, this.parameters, this.results, this.paging, this.totalPlayer});

  TotalPlayersDetails.fromJson(Map<String, dynamic> json) {
    get = json['get'];
    ...
    if (json['response'] != null) {
      ...
      json['response'].forEach((v) {
        totalPlayer!.add(new TotalPlayer.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.totalPlayer != null) {
      data['response'] = this.totalPlayer!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class TotalPlayer {
  ...
  TotalPlayer({this.player, this.statistics});

  TotalPlayer.fromJson(Map<String, dynamic> json) {
    player =
...
class Substitutes {
  ...
  Substitutes({this.subIn, this.subOut, this.bench});
